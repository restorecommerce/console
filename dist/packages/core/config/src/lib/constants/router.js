                ...
                auth: {
                    ...
                    children: {
                        ...
                        activation: {
                            ...
                            title: 'Activation',
                            getLink: (params) => (params === null || params === void 0 ? void 0 : params.identifier) && (params === null || params === void 0 ? void 0 : params.code)
                ...
                orders: {
                    ...
                    children: {
                        ...
                        view: {
                            ...
                            link: '/orders/:id/view',
                            title: 'Order',
                            getLink: (params) => (params === null || params === void 0 ? void 0 : params.id) ? ['', 'orders', params.id, 'view'] : ['', 'orders'],
                        },
                        edit: {
                            path: ':id/edit',
                            link: '/orders/:id/edit',
                            title: 'Edit',
                            getLink: (params) => (params === null || params === void 0 ? void 0 : params.id) ? ['', 'orders', params.id, 'edit'] : ['', 'orders'],
                        },
                    },
                },
                products: {
                        ...
                        catalogs: {
                            ...
                            children: {
                                ...
                                view: {
                                    ...
                                    title: 'Catalog',
                                    getLink: (params) => (params === null || params === void 0 ? void 0 : params.id)
